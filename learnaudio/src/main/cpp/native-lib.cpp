...
Java_cn_idu_learnvideo_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_cn_idu_learnvideo_Mp3Encoder_init(JNIEnv *env, jobject thiz, jstring pcm_path,
...
extern "C"
JNIEXPORT void JNICALL
Java_cn_idu_learnvideo_Mp3Encoder_encode(JNIEnv *env, jobject thiz) {
    mp3Encoder->Encode();
}

extern "C"
JNIEXPORT void JNICALL
Java_cn_idu_learnvideo_Mp3Encoder_destory(JNIEnv *env, jobject thiz) {
    mp3Encoder->Destory();
}